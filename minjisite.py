...
st.markdown(f"""
    <style>
        ...
        .stButton button {{
            ...
            width: 100%;
            border-radius: 10px;
            border: 1px solid #ff69b4;  /* 버튼 윤곽선을 분홍색으로 변경 */
            padding: 15px 30px;
            color: #ff69b4;  /* 버튼 텍스트를 분홍색으로 변경 */
        ...
        .small-button {{
            ...
            width: auto;
            border-radius: 5px;
            border: 1px solid #ff69b4;  /* 작은 버튼 윤곽선을 분홍색으로 변경 */
            padding: 8px 15px;
            color: #ff69b4;  /* 작은 버튼 텍스트를 분홍색으로 변경 */
            background-color: #ffffff;
            font-size: 0.8em;
            font-weight: 600;
            transition: all 0.3s ease-in-out;
...
# 사이드바에 버튼 배열
st.sidebar.header("클릭해보라")

large_buttons = {
    "나의 아바타": "민쥐 영상.mp4",  # 이 경로를 실제 아바타 비디오 파일로 변경하세요.
    "나를 표현한 음악": "민쥐 노래.mp3"  # 이 경로를 실제 음악 파일로 변경하세요.
}
...
# 사용자 입력을 받는 입력 창
user_input = st.text_input("뭐가 궁금한데:")
